...
- `terraform-policytest` - standard `*.policytest.hcl` files
...
in `**/*.tf`, `**/*.tfvars`, `**/*.tfstack.hcl`, `**/*.tfcomponent.hcl`, `**/*.tfdeploy.hcl`, `**/*.tfquery.hcl`, `**/*.policy.hcl` and `**/*.policytest.hcl` files in the workspace.
