...
func makeTextEditUpdate(old, new sourceLine) lsp.TextEdit {
	...
	return lsp.TextEdit{
		Range: lsp.Range{
			Start: lsp.Position{Line: new.rng.Start.Line - 1, Character: 0},
			End:   lsp.Position{Line: new.rng.Start.Line - 1, Character: l},
		},
...
func makeTextEditInsert(new sourceLine) lsp.TextEdit {
	pos := lsp.Position{Line: new.rng.Start.Line - 1, Character: 0}
	return lsp.TextEdit{
		Range: lsp.Range{
			Start: pos,
			End:   pos,
...
func makeTextEditDelete(old sourceLine) lsp.TextEdit {
	...
	return lsp.TextEdit{
		Range: lsp.Range{
			Start: lsp.Position{Line: old.rng.Start.Line - 1, Character: 0},
			End:   lsp.Position{Line: old.rng.Start.Line, Character: 0},
		},
		NewText: "",
	}
}
