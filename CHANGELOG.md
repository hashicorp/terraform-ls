...
* Add support for Terraform Policy files. This provides block and attribute completion, hover, and diagnostics along with syntax validation for Terraform Policy files. ([#2105](https://github.com/hashicorp/terraform-ls/issues/2105)) ([#2156](https://github.com/hashicorp/terraform-ls/issues/2156))
